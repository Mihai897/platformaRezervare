...
const Oferte = () => {
  return (
    <div>
      <div className='max-w-screen-2xl mx-auto px-15 max-modf:px-10 max-modf1:px-8 py-4'>
      ...
      <Explore />
      <div className='flex space-x-4 max-modf:flex-col items-start max-w-screen-2xl mx-auto px-15 max-modf:px-10 max-modf1:px-8 py-4 max-modf:space-y-4'>
        <HotelSidebar />
        <ListaOferte />
      </div>
    </div>
