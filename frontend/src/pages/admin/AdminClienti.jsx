  ...
  return (
    <div className='mt-18'>
      ...
      <ul className={`mt-4 grid grid-cols-4  gap-3 text-[14px] ${visibleBara?"max-modf3:grid-cols-2 max-modf1:grid-cols-1":" max-modf:grid-cols-2 max-modf2:grid-cols-1"}`}>
        ...
        {
          [
            {icon:"total",textIc:"text-button",bgIc:"bg-button/30",nume:"Total clienti",nr:"1.248",procent:"+18%",culProcent:"text-green-400",text:"fata de luna trecuta"},
            {icon:"noi",textIc:"text-green-400",bgIc:"bg-green-400/30",nume:"Clienti noi",nr:"312",procent:"+22%",culProcent:"text-green-400",text:"fata de luna trecuta"},
            {icon:"fideli",textIc:"text-blue-400",bgIc:"bg-blue-400/30",nume:"Clienti fideli",nr:"936",procent:"+15%",culProcent:"text-green-400",text:"fata de luna trecuta"},
            {icon:"venituri",textIc:"text-orange-400",bgIc:"bg-orange-400/30",nume:"Valoarea totala generata",nr:"1.245.860 RON",procent:"+25%",culProcent:"text-green-400",text:"fata de luna trecuta"},
          ].map((par,i)=>{
        ...
        <div className={`border py-3 mt-4 rounded-lg border-button/30`}>
          ...
          <div className={`overflow-x-auto scrollbar-thin text-[14px] min-w-0`}>
            ...
            <ul className={`space-y-3 mt-3 text-gray-400`}>
              {
                clienti?.map((client,i)=>{
                  
                  
                  return(
                  <li key={i} className='flex relative space-x-3 px-3 py-3 border-y border-y-button/30 min-w-max items-center '>
                    ...
                    <div className={`${visibleBara? "max-modf7:w-60":"max-modf7:w-70"} modf7:flex-2 shrink-0 transition-[width] duration-300 ease-in-out flex space-x-3 items-center`}>
                      ...
                      <div className='w-15 h-15 rounded-full '>
                        <img className='w-full h-full object-center rounded-full' src={client.pozaProfil} alt="" />
                      </div>
                        <p className='text-white font-medium'>{client.nume}</p>
                    </div>
                    <div className={`${visibleBara? "max-modf7:w-55":"max-modf7:w-63"} modf7:flex-2 shrink-0 transition-[width] duration-300 ease-in-out`}>
                      <p>{client.email}</p>
                      <p>{client.nrTelefon}</p>
                    ...
                    <div className={`${visibleBara? "max-modf7:w-27":"max-modf7:w-33"} modf7:flex-1 shrink-0 transition-[width] duration-300 ease-in-out text-center`}>
                      <p>
                        {client?.rezervari[client?.rezervari?.length-1]?.data}
                        ...
                        <div className='relative'>
                          ...
                          </button>
                          {
                            visibleActiuni === client.id && (
                              <div className={`absolute right-10 z-800 ${i===clienti.length-1?"-bottom-3":"top-1/2 -translate-y-1/2"}`}>
                                <div className='border  rounded-lg  px-1 py-0.5 relative border-button bg-background w-46 '>
                                  ...
                                  <div className={`absolute w-3 h-3    bg-button  -right-3 ${i===clienti.length-1? "bottom-5":"top-1/2 -translate-y-1/2"}`} style={{clipPath:"polygon(0 0,100% 50%,0 100%)",}}></div>
                                  <div className={`absolute w-3 h-3  border-r border-r-button/30 bg-background  -right-2.75 ${i===clienti.length-1? "bottom-5":"top-1/2 -translate-y-1/2"}`} style={{clipPath:"polygon(0 0,100% 50%,0 100%)",}}></div>
                                </div>
                              </div>
                            )
                          }
                            ...
                            <div className='mt-2 flex modf8:space-x-3 max-modf8:flex-col '>
                              ...
                              <div className='text-center max-modf8:mx-auto  w-38 flex flex-col items-center '>
                                <div className='w-25   h-25 rounded-full'>
                                  <img className='w-full h-full rounded-full' src={modalClienti.client.pozaProfil} alt="" />
                                </div>
                                <p className='text-white'>{modalClienti.client.nume} </p>
                                <p className='text-blue-400'>Client fidel</p>
                                <p className='text-[12px]'>Client din 15 ian. 2023</p>
                              </div>
                              ...
                              <div className='flex-2 max-modf8:mt-1.5'>
                                <div className='w-[95%] space-y-1.5'>
                                  ...
                                  <div className='flex justify-between  space-x-3'>
                                    <p>Telefon</p>
                                    <p>{modalClienti.client.nrTelefon}</p>
                                  </div>
                                  <div className='flex justify-between  space-x-3'>
                                    <p>Tara</p>
                              ...
                              <ul className=' w-[96.5%] grid grid-cols-2 max-modf8:grid-cols-1 gap-3 border px-3 py-2 rounded-lg border-button/30 mt-3'>
                                {
                                  [
                                    ...
                                    {nume:'Valoare totala rezervari',text:`${modalClienti.client.totalClient} RON`},
                                    {nume:'Valoare medie rezervari',text:`${modalClienti.client.totalClient/modalClienti.client.rezervari.length} RON`},
                                    {nume:'Ultima rezervare',text:`${modalClienti.client.rezervari[modalClienti.client.rezervari.length-1].data}`},
                                  ].map((stat,iStat)=>(
                                  ...
                                  modalClienti.client.rezervari.map((rezervariClient, iRez)=>(
                                    <li key={iRez} className='flex space-x-3 px-3 py-3 min-w-max border-y items-center border-y-button/30'>
                                      <div className={`w-25  shrink-0`}>
                                        <p>{rezervariClient.codRezervare}</p>
                                        <p>{rezervariClient.data}</p>
                                      </div>
                                      <div className={`w-35  shrink-0`}>
                                        <p>{rezervariClient.checkIn} - {rezervariClient.checkOut}</p>
                                      </div>
                                      <div className={`w-45  shrink-0`}>
                                        <p>{rezervariClient.numeHotel}</p>
                                        <p>{rezervariClient.numeCamera}</p>
                                      </div>
                                      <div className={`w-25  shrink-0`}><p>{rezervariClient.pretRez} RON</p></div>
                                      <div className={`w-20  shrink-0 text-center`}>
                                        <p className={`${rezervariClient.status==="Finalizata"? "bg-green-400/30 text-green-400": "bg-red-400/30 text-red-400"}`}>{rezervariClient.status}</p>
                                      </div>
                                    </li>
                                  ))
                                }
                        ...
                        <div className='border border-button bg-background w-125 rounded-lg px-3 py-3 overflow-y-auto overflow-hidden scrollbar-thin max-h-[95vh]'>
                          ...
                          <div>
                            ...
                            <div className="border border-button/30 rounded-sm px-3 py-2 ">
                              {modalClienti.client.nume} ({modalClienti.client.email})
                            </div>
                      ...
                      {modalClienti.actiune === 3 && (
                        <div className='border border-button bg-background w-125 rounded-lg px-3 py-3 overflow-y-auto overflow-hidden scrollbar-thin max-h-[95vh]'>
                          ...
                          <div>
                            ...
                            <div className="border border-button/30 rounded-sm px-3 py-2 ">
                              {modalClienti.client.nume} ({modalClienti.client.nrTelefon})
                            </div>
                          ...
                          <div className='border border-button w-110 bg-background rounded-lg px-3 py-3 overflow-y-auto overflow-hidden scrollbar-thin max-h-[95vh]'>
                            ...
                            <div className='flex justify-center flex-col items-center text-center max-modf8:px-0     px-10'>
                              ...
                              <div className='w-full  mt-1 text-white'>
                                <p>Esti sigur ca doresti sa stergi clientul <span className='font-medium text-red-600'> {modalClienti.client.nume}</span></p>
                              </div>
