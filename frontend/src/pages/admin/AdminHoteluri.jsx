      ...
      {showAdminHotelPage &&(<div >
        ...
        <ul className={`grid max-modf1:grid-cols-2 grid-cols-4 ${visibleBara?"max-modf:grid-cols-2": "max-modf:grid-cols-4"} text-[14px] gap-3 mt-4 }`}>
          {
            [
              ...
              {nume:"Active",nr:10,icon:"Activ",bgI:"bg-green-400/30",colI:"text-green-400" },
              {nume:"In asteptare",nr:1,icon:"Asteptare",bgI:"bg-orange-400/30",colI:"text-orange-400" },
              {nume:"Inactive",nr:1,icon:"Inactive",bgI:"bg-red-400/30",colI:"text-red-400" }
            ].map((par,i)=>{
        ...
        <div className='border border-button/30 space-y-3  py-3 rounded-lg mt-4 text-[14px]'>
          ...
          <ul className='overflow-x-auto space-y-3 scrollbar-thin min-w-0 pb-3 w-full'>
            ...
            {
            hotels?.map((par,i)=>(
              <li key={i} className='border-y py-3 px-3 min-w-max border-y-button/30 text-gray-400'>
                ...
                <div className='flex items-center space-x-3 mt-3'>
                  ...
                  <div className={`${visibleBara?"max-modf7:w-63":"max-modf7:w-75"} transition-[width] duration-300 ease-in-out max-modf7:shrink-0 flex space-x-3 items-center modf7:flex-2`}>
                    <div className='w-15 h-15 rounded-lg shrink-0 overflow-hidden'>
                      <img className='w-full h-full object-center rounded-lg hover:scale-110 transition-all duration-300 ease-in-out' src={par.img} alt="" />
                    </div>
                  ...
                  <div className={`${visibleBara?"max-modf7:w-23 ":"max-modf7:w-25"} transition-[width] duration-300 ease-in-out max-modf7:shrink-0  modf7:flex-1`}>
                    <div className='flex space-x-1.5 items-center'>
                      ...
                      <p className='text-white '>{par.nrRecenzie}</p>
                    </div>
                    <p>{par.textRecenzie}</p>
                  </div>
                  ...
                  <div className={`${visibleBara?"max-modf7:w-30":"max-modf7:w-33"} transition-[width] duration-300 ease-in-out max-modf7:shrink-0  modf7:flex-1`}>
                    <div>
                      <p className='text-white'>35.000 RON</p>
                          ...
                          <div className='grid grid-cols-2 max-modf2:grid-cols-1 gap-3'>
                            <div className='mt-1.5 space-y-1.5'>
                              <div className='h-40 w-full max-modf2:h-60 max-modf8:h-40 relative'>
                                <img  src={modalHotelActiuni.par.img} className='w-full h-full rounded-lg' alt="" />
                                <div className='absolute right-3 top-1 px-3 bg-green-600 text-white rounded-sm'>Activ</div>
                              </div>

                              <div className='grid grid-cols-5 gap-1.5'>
                                <div>
                                  <img className='rounded-sm' src={modalHotelActiuni.par.img} alt="" />
                                </div>
                                <div>
                                  <img className='rounded-sm' src={modalHotelActiuni.par.img} alt="" />
                                </div>
                              ...
                              <div className='mt-3'>
                                ...
                                <ul className='grid grid-cols-2 mt-1 gap-1.5 text-gray-400 list-disc ml-3 marker:text-button'>
                                  {
                                    modalHotelActiuni.par.facilitati.map((fac,iFac)=>(
                                      <li key={iFac}>{fac.facilitate[0]}</li>
                                    ))
                                  }
                                </ul>
                              </div>
                            ...
                            <div className='space-y-1.5'>
                              ...
                              <div className='flex items-center space-x-1.5'>
                                <FaStar className='text-yellow-400'/>
                                <p className='font-medium'>{modalHotelActiuni.par.nrRecenzie}</p>
                                <p className='text-gray-400'>({modalHotelActiuni.par.textRecenzie})</p>
                              </div>
                              <div className='flex items-center space-x-1.5'>
                                <GoLocation size={18}/>
                              ...
                              <div className='space-y-1 border border-button/30 px-1.5 py-1.5 rounded-lg'>
                                ...
                                <div className='grid grid-cols-2 gap-1.5'>
                                  ...
                                  <p>{modalHotelActiuni.par.rooms.length}</p>
                                </div>
                                <div className='grid grid-cols-2 gap-1.5'>
                              ...
                              <div className='grid grid-cols-2 gap-1.5'>
                                <div className='border border-button/30 text-center px-1.5  py-2 rounded-lg'>
                                  ...
                                  <p className='text-gray-400 mt-1.5'>48 rezervari</p>
                                  <p className='text-green-400'>+15%</p>
                                </div>
                                <div className='border border-button/30 text-center px-1.5  py-2 rounded-lg'>
                                  <div className=' flex justify-center'>
                                  ...
                                  <p className='text-gray-400 mt-1.5'>35.000 RON</p>
                                  <p className='text-green-400'>+19%</p>
                                </div>
                              </div>
                            </div>
                        ...
                        <div className='border border-button max-h-[95vh] px-3 py-3 rounded-lg overflow-y-auto overflow-hidden scrollbar-thin bg-background w-185'>
                          ...
                          <div className='grid grid-cols-2 gap-3 max-modf2:grid-cols-1'>
                            ...
                            <div>
                              <div className='grid grid-cols-2 max-modf8:grid-cols-1 gap-3'>
                                ...
                                <div>
                                  <p>Telefon</p>
                                  <input className='border border-button/30 w-full outline-0 px-1 py-1 mt-1 rounded-lg placeholder:text-white' type="text" name="" id="" defaultValue="+960 123 4567"/>
                                </div>

                                <div>
                                  <p>Email</p>
                                  <input className='border border-button/30 w-full outline-0 px-1 py-1 mt-1 rounded-lg placeholder:text-white' type="text" name="" id="" defaultValue="info@hotel.com"/>
                                </div>

                                <div>
                                  <p>Website</p>
                                  <input className='border border-button/30 w-full outline-0 px-1 py-1 mt-1 rounded-lg placeholder:text-white' type="text" name="" id="" defaultValue="www.hotel1.com"/>
                                </div>
                          ...
                          <div className='mt-3'>
                            ...
                            <ul className='mt-1 overflow-x-auto scrollbar-thin  pr-3 min-w-0 '>
                              {
                                modalHotelActiuni.par.facilitati.map((fac,iFac)=>(
                                  <li className=' min-w-max' key={iFac}>
                                    ...
                                    <ul className='flex space-x-3 px-3 pb-3'>
                                      {
                                        fac.facilitate.map((facil,iFacil)=>(
                                          <li className='shrink-0 mt-3 border-button/30 bg-button/30 border px-1.5 py-1 flex items-center space-x-1  min-w-max' key={iFacil}>
                                            <p>{facil}</p>
                      ...
                      modalHotelActiuni.actiune === 2 && (
                        <div className='border border-button max-h-[95vh] px-3 py-3 rounded-lg overflow-y-auto overflow-hidden scrollbar-thin bg-background w-110'>
                          ...
                          <div className='flex mt-1 items-center space-x-3'>
                            <div className={`${modalHotelActiuni.par.stareActivareHotel === false?"text-orange-400 bg-orange-400/14":"text-green-400 bg-green-400/14"} px-3 py-3 rounded-full  shrink-0 text-[22px]`}>
                              <BsPatchExclamation className='shrink-0'/>
                            </div>
                            {
                              modalHotelActiuni.par.stareActivareHotel === false ? (
                                <div>
                              ...
                              modalHotelActiuni.par.stareActivareHotel === false? (
                                <button onClick={()=>{setModalHotelActiuni(null); document.body.classList.remove("overflow-hidden");
                                  setHotels(prev=>prev.map(hotel=>(
                                    hotel.id === modalHotelActiuni.par.id ? {...hotel, stareActivareHotel:true}: hotel
                                  )
                                  ))
                                ...
                                <button onClick={()=>{setModalHotelActiuni(null); document.body.classList.remove("overflow-hidden");
                                    setHotels(prev=>prev.map(hotel=>(
                                      hotel.id === modalHotelActiuni.par.id ? {...hotel, stareActivareHotel:false}: hotel
                                    )
                                    ))
