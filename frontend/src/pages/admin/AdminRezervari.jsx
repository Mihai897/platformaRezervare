    ...
    <div className='mt-18'>
      {viziblePagineAdminRezervare &&(<div >
        ...
        <ul className={`grid grid-cols-5 max-modf6:grid-cols-3 ${visibleBara? "max-modf2:grid-cols-1":"max-modf2:grid-cols-2"} max-modf:grid-cols-2 gap-3 mt-4 text-[14px]`}>
          { 
            [ {nume:"Toate rezervarile",nr:"248",text:"Rezervari totale",icon:"Toate",bgC:"bg-button/30",textC:"text-button"},
              {nume:"Confirmate",nr:"180",inPlus:"+12",procent:"%",text:"fata de luna trecuta",icon:"Confirmate",bgC:"bg-green-400/30",textC:"text-green-400"},
              {nume:"In asteptare",nr:"34",inPlus:"+5",procent:"%",text:"fata de luna trecuta",icon:"InAsteptare",bgC:"bg-orange-400/30",textC:"text-orange-400"},
              {nume:"Anulate",nr:"18",inPlus:"-3",procent:"%",text:"fata de luna trecuta",icon:"Anulate",bgC:"bg-red-400/30",textC:"text-red-400"},
              {nume:"Finalizate",nr:"16",inPlus:"+8",procent:"%",text:"fata de luna trecuta",icon:"Finalizate",bgC:"bg-green-400/30",textC:"text-green-400"}
            ].map((par,i)=>{
              ...
              <li key={i} className='border border-button/30 rounded-lg px-3 py-3 flex items-center space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-[12px] text-gray-400'><span  className={`${par.inPlus<0?"text-red-400": "text-green-400"}`}>{par.inPlus}{par.procent} </span>{par.text}</p>
                </div>
              </li>
            )})
          }
        ...
        <div className='text-[14px] mt-4 flex flex-wrap space-x-3 space-y-3 modf6:justify-between items-end '>
          ...
          <div className='w-48'>
            ...
            <div className='relative'>
              ...
              <ul className={`absolute text-start transition-all z-100 duration-500 ease-in-out bg-background ${visibleHotel ? "max-h-100 opacity-100": "max-h-0 opacity-0"} w-full h-43 overflow-hidden left-0 overflow-y-scroll scrollbar-hide`}>
                <div className='px-3 py-1.5 border border-button/30 hover:bg-button/60 cursor-pointer'>
                  <p>Toate hotelurile</p>
                </div>
                {
                  hotels?.map((par,i)=>(
                    <li key={i} className='px-3 py-1.5 border border-button/30 hover:bg-button/60 cursor-pointer'>{par.nume}</li>
                  ))
                }
              </ul>
            </div>
        ...
        <div className='text-[14px] border py-3 border-button/30  rounded-lg'>
          ...
          <ul className=' overflow-x-auto  scrollbar-thin w-full text-[12.5px] text-gray-400 space-y-3 mt-3 pb-2'>
            ...
            {
              rezervare?.map((par,i)=>(
                <li key={i} className=' px-3 py-1.5 border-y min-w-max border-y-button/30 '>
                  ...
                  <div className='flex items-center space-x-3'>
                    ...
                    <div className={`${visibleBara?"max-modf7:w-20":"max-modf7:w-23"} transition-[width] duration-300 ease-in-out max-modf7:shrink-0 modf7:flex-1 `}>
                      <p className='text-white'>{par.codRezervare}</p>
                    </div>
                    ...
                    <div className={`${visibleBara?"max-modf7:w-38":"max-modf7:w-48"} transition-[width] duration-300 ease-in-out max-modf7:shrink-0 modf7:flex-2`}>
                      <p className='text-white'>{par.numeClient}</p>
                      <p>{par.emailClient}</p>
                      <p>{par.nrTelefon}</p>
                    </div>
                    ...
                    <div className={`${visibleBara? "max-modf7:w-60":"max-modf7:w-70"} transition-[width] duration-300 ease-in-out max-modf7:shrink-0 modf7:flex-3  flex items-center space-x-3`}>
                      ...
                      <div className='w-10 h-10 shrink-0 rounded-lg overflow-hidden'>
                        <img className='w-full  h-full transition-all duration-300 ease-in-out object-center rounded-lg hover:scale-110' src={par.cameraImg} alt="" />
                      </div>
                      
                      <div className=''>
                        <p className='text-white'>{par.numeHotel}  </p>
                        <p>{par.numeCamera}</p>
                      </div>
                    </div>
                    ...
                    <div className={`${visibleBara?"max-modf7:w-20":"max-modf7:w-23"} transition-[width] duration-300 ease-in-out max-modf7:shrink-0 modf7:flex-1`}>
                      <p className='text-white'>{par.nrOaspetiAdulti}</p>
                      <p>{par.nrOaspetiCopii}</p>
                    </div>

                    <div className={`${visibleBara?"max-modf7:w-20":"max-modf7:w-23"} transition-[width] duration-300 ease-in-out max-modf7:shrink-0 modf7:flex-1`}>
                      <p className='text-white'>{par.pretTotal}</p>
                      <p>{par.periadaCazare}</p>
                    </div>

                    <div className={`${visibleBara?"max-modf7:w-20":"max-modf7:w-23"} transition-[width] duration-300 ease-in-out max-modf7:shrink-0 modf7:flex-1`}>
                      <p className={`${par.bgStatus} ${par.textStatus} text-center rounded-sm`}>{par.status}</p>
                    </div>
                    ...
                    <div className={`${visibleBara?"max-modf7:w-15":"max-modf7:w-23"} transition-[width] duration-300 ease-in-out max-modf7:shrink-0 modf7:flex-1`}>
                      <div className='flex justify-center space-x-3 '>
                          ...
                          <div className='relative'>
                            <button onClick={()=>{setVisibleActiuneRezMeniu(visibleActiuneRezMeniu === i? null: i);}} className='px-1.5 py-1.5 border cursor-pointer rounded-sm border-button/30'>
                              <BsThreeDotsVertical />
                            </button>

                            {
                              visibleActiuneRezMeniu === i && (
                                <ul className={`absolute right-10 ${visibleActiuneRezMeniu === rezervare.length-1?"-bottom-3":"top-1/2 -translate-y-1/2"}  w-40 border border-button rounded-lg bg-background z-600`}>
                                  <div className='relative  px-1 py-1'>
                                      ...
                                      <div className={`absolute w-3 h-3 bg-button -right-3 ${visibleActiuneRezMeniu=== rezervare.length-1? "bottom-4.5":"top-1/2 -translate-y-1/2"}`} style={{clipPath: "polygon(0 0, 100% 50%, 0 100%)"}}></div>
                                      <div className={`absolute w-3 h-3 bg-background -right-2.75 ${visibleActiuneRezMeniu=== rezervare.length-1? "bottom-4.5":"top-1/2 -translate-y-1/2"}`} style={{clipPath: "polygon(0 0, 100% 50%, 0 100%)"}}></div>
                                  </div>
                                </ul>
                              )
                            }
                          ...
                          <div className='grid grid-cols-2 mt-2 gap-3 max-modf2:grid-cols-1'>
                            <div >
                              ...
                              <div className='flex justify-between space-x-3 items-center border px-2 py-1.5 rounded-lg border-button/30'>
                                <div>
                                  <p>Cod rezervare</p>
                                  <p>{modalActRez.par.codRezervare}</p>
                                </div>
                                <div>
                                  <p className={`${modalActRez.par.bgStatus} ${modalActRez.par.textStatus} px-2 py-0.5 rounded-sm`}>{modalActRez.par.status}</p>
                                </div>
                              </div>
                              ...
                              <div className='mt-2 border border-button/30 rounded-lg px-2 py-1.5 items-start flex space-x-3 '>
                                ...
                                <div>
                                  <p>{modalActRez.par.numeClient}</p>
                                  <p className='text-gray-400'>{modalActRez.par.nrTelefon}</p>
                                  <p className='text-gray-400'>{modalActRez.par.emailClient}</p>
                                </div>
                              </div>
                              ...
                              <div className='border mt-2 border-button/30 px-3 py-1.5 '>
                                ...
                                <div className='grid grid-cols-2 gap-3'>
                                  ...
                                  <p>{modalActRez.par.checkIn}, ora: {modalActRez.par.oraCheckIn}</p>
                                </div>

                                
                                <div className='grid grid-cols-2 gap-3'>
                                  <p className='text-gray-400'>Check-out</p>
                                  <p>{modalActRez.par.checkOut}, ora: {modalActRez.par.oraCheckOut}</p>
                                </div>

                                <div className='grid grid-cols-2 gap-3'>
                                  <p className='text-gray-400'>Durata sejur</p>
                                  <p>{modalActRez.par.periadaCazare}</p>
                                </div>

                                <div className='grid grid-cols-2 gap-3'>
                                  <p className='text-gray-400'>Oaspeti</p>
                                  <p>{modalActRez.par.nrOaspetiAdulti}, {modalActRez.par.nrOaspetiCopii}</p>
                                </div>
                              ...
                              <div className='mt-2 border border-button/30 px-3 py-1.5'>
                                ...
                                <div className='mt-1.5'>
                                  <p className='text-gray-400'>Sosire tarzie in jurul orei 22:00. Prefera camere la etaj superior, vedere la laguna.</p>
                                </div>
                            ...
                            <div>
                              <div className='border border-button/30 px-3 py-1.5 rounded-sm'>
                                ...
                                <div className='flex space-x-3 mt-1.5 items-center'>
                                  <div className='flex-1'>
                                    <img className='rounded-lg' src={modalActRez.par.cameraImg} alt="" />
                                  </div>
                                  <div className='flex-2'>
                                    <p>{modalActRez.par.numeHotel}</p>
                                    <p className='text-gray-400'>{modalActRez.par.numeCamera}</p>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className='border border-button/30 px-3 py-1.5 mt-2 rounded-sm'>
                                ...
                                <div className='mt-1.5 flex space-x-3 justify-between'>
                                  <p className='text-gray-400'>Pret camera ({modalActRez.par.periadaCazare})</p>
                                  <p>{modalActRez.par.pretTotalNr} RON</p>
                                </div>
                                ...
                                <div className='mt-1.5 flex space-x-3 justify-between'>
                                  ...
                                  <p className='text-green-400'>-30 RON</p>
                                </div>

                                <div className='mt-1.5 border-t border-y-button/30'>
                                  <div className='mt-1.5 flex space-x-3 justify-between'>
                                    <p>Total platit</p>
                                    <p>{modalActRez.par.pretTotalNr+100-30}RON</p>
                                  </div>
                      ...
                      modalActRez.actiune === 1 && (
                        <div className='border border-button rounded-lg overflow-y-auto overflow-hidden max-h-[95vh] scrollbar-thin px-3 py-3 bg-background w-110'>
                          ...
                          <div className='mt-1.5'>
                            ...
                            <p>{modalActRez.par.codRezervare}</p>
                            <p>{modalActRez.par.numeCamera}</p>
                            <p>{modalActRez.par.numeClient}</p>

                            <div className='flex space-x-3 items-center'>
                              <p>Status curent:</p>
                              <p className={`${modalActRez.par.bgStatus} ${modalActRez.par.textStatus} px-3`}>{modalActRez.par.status}</p>
                            </div>
                          </div>
                        ...
                        <div className='border border-button rounded-lg overflow-y-auto overflow-hidden max-h-[95vh] scrollbar-thin px-3 py-3 bg-background w-125'>
                          ...
                          <div className='text-gray-400 border border-button/50 rounded-lg px-3 py-3 mt-3'>
                            ...
                            <div className='grid grid-cols-2 gap-3 max-modf8:grid-cols-1 max-modf8:gap-1.5 mt-1.5'>
                              <div>
                                <p>Cod rezervare: <span className='ml-3 text-button'>{modalActRez.par.codRezervare}</span></p>
                                <p>Client: <span className='ml-3 text-white'>{modalActRez.par.numeClient}</span></p>
                                <p>Email: <span className='ml-3 text-white'>{modalActRez.par.emailClient}</span></p>
                              </div>
                              <div>
                                <p>Hotel: <span className='ml-3 text-button'>{modalActRez.par.numeHotel}</span></p>
                                <p>Camera: <span className='ml-3 text-white'>{modalActRez.par.numeCamera}</span></p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className='mt-3'>
                            <p>Catre</p>
                            <p className='mt-1.5 border w-full border-button/50 px-3 py-1.5 rounded-lg'>{modalActRez.par.emailClient}</p>
                          </div>

                          <div className='mt-3'>
                            <p>Subiect</p>
                            <input className='w-full border border-button/50 px-3 py-1.5 mt-1.5 outline-0 rounded-lg' type="text" defaultValue={`Confirmarea rezervarii ${modalActRez.par.codRezervare}`} name="" id="" />
                          </div>
                          ...
                          <div className='mt-3'>
                            <p>Continut mesaj</p>
                            <textarea className='w-full scrollbar-thin h-30 outline-0 border border-button/30 resize-none px-3 py-1.5 rounded-lg mt-3' name="" defaultValue={`Buna ${modalActRez.par.numeClient},

  Va multumim pentru alegerea ${modalActRez.par.numeHotel}.
  Rezervarea dumneavoastra cu numarul ${modalActRez.par.codRezervare} este confirmata pentru perioada ${modalActRez.par.checkIn} - ${modalActRez.par.checkOut}.
                        ...
                        <div className='border border-button rounded-lg overflow-y-auto overflow-hidden max-h-[95vh] scrollbar-thin px-3 py-3 bg-background w-120'>
                          ...
                          <div className='mt-3 flex border border-button/30 rounded-lg px-3 py-3 modf8:space-x-3 max-modf8:space-y-3 max-modf8:flex-col'>
                            <div className='modf8:flex-1'>
                              <img className='w-full h-full max-modf8:h-50 shrink-0 rounded-lg' src={modalActRez.par.cameraImg} alt="" />
                            </div>
                            <div className='modf8:flex-2'>
                              <div className='flex space-x-3 flex-wrap items-center'>
                                <p>Rezervare {modalActRez.par.codRezervare}</p>
                                <p className={`${modalActRez.par.bgStatus} ${modalActRez.par.textStatus} px-3  rounded-sm`}>{modalActRez.par.status}</p>
                              </div>
                              <p className='mt-1'>{modalActRez.par.numeHotel} </p>
                              <div className='flex items-center text-gray-400 space-x-1.5 mt-1'>
                                <BsCalendar2 size={15}/>
                                <p>{modalActRez.par.checkIn} - {modalActRez.par.checkOut} ({modalActRez.par.periadaCazare})</p>
                              </div>
                              <div className='flex items-center text-gray-400 space-x-1.5 mt-1'>
                                <FaUser size={15}/>
                                <p>{modalActRez.par.numeClient}</p>
                        ...
                        <div className='border border-button bg-background overflow-y-auto overflow-hidden max-h-[95vh] scrollbar-thin px-3 py-3 rounded-lg w-100'>
                          ...
                          <div className='text-center'>
                            ...
                            <div className='text-gray-400 w-[85%] mt-0.5 mx-auto'>
                              <p>Esti sigur ca doresti sa anulezi rezervarea?</p>
                            </div>
                          </div>
