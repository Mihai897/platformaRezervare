        ...
        <div className={`grid ${visibleBara?"max-modf4:grid-cols-1":"max-modf:grid-cols-1"} grid-cols-2 px-3 gap-3 pb-3 border-b-button/30 border-b`}>
          ...
          <div>
            ...
            <div className='text-gray-400'>
              <p className='mt-2'>Nume complet <span className='text-red-600'>*</span></p>
              <input className='border w-full border-button/30 px-3 rounded-sm outline-0 text-white py-2 mt-2' type="text" placeholder='Ex: Maria Popa' name="" id="" />
            </div>
            <div className='text-gray-400'>
          ...
          <div>
                ...
                <ul className={`absolute z-30  transition-all duration-500 ease-in-out ${visibleHotelList?"max-h-30 opacity-100":"max-h-0 opacity-0"} overflow-hidden overflow-y-auto scrollbar-thin bg-background w-full `}>
                  {
                    hotels.map((hotel,ihotel)=>(
                      <li className='px-3 py-2 border border-button/30 cursor-pointer hover:bg-button/30 transition-all duration-300 ease-in-out' key={ihotel}>
                        <p>{hotel.nume}</p>
                      </li>
                    ))
                  }
            ...
            <div className='text-gray-400'>
              ...
              <div className='relative w-full mt-2'>
                ...
                <ul className={`absolute z-30  transition-all duration-500 ease-in-out ${visibleCameraList?"max-h-30 opacity-100":"max-h-0 opacity-0"} overflow-hidden overflow-y-scroll scrollbar-thin bg-background w-full `}>
                  {
                    hotels[0].rooms.map((camera,icamera)=>(
                      <li className='px-3 py-2 border border-button/30 cursor-pointer hover:bg-button/30 transition-all duration-300 ease-in-out' key={icamera}>
                        <p>{camera.title}</p>
                      </li>
                    ))
                  }
            ...
            <div className='text-gray-400 grid grid-cols-2 max-modf2:grid-cols-1 gap-3'>
              <div className='mt-2'>
                ...
                <input type="date" className='border border-button/30 px-3 py-2 mt-2 w-full outline-0 rounded-sm' />
              </div>
              <div className='mt-2'>
            ...
            <div className='text-gray-400'>
              ...
              <div className='grid grid-cols-3 gap-3'>
                <div className='mt-2'>
                  <p>Adulti</p>
                  <input className='border border-button/30 w-full px-3 py-2 outline-0 rounded-sm mt-1' min={0} type="number" defaultValue={0} name="" id="" />
                </div>
                <div className='mt-2'>
                  <p>Copii</p>
                  <input className='border border-button/30 w-full px-3 py-2 outline-0 rounded-sm mt-1' min={0} defaultValue={0} type="number" name="" id="" />
                </div>
                <div className='mt-2'>
                  <p>Sugari</p>
                  <input className='border border-button/30 w-full px-3 py-2 outline-0 rounded-sm mt-1' min={0} type="number" defaultValue={0} name="" id="" />
          ...
          <div className={`grid ${visibleBara?"max-modf4:grid-cols-3 max-modf:grid-cols-2 max-modf2:grid-cols-1":"max-modf:grid-cols-3 max-modf1:grid-cols-2 max-modf2:grid-cols-1"} grid-cols-4 gap-x-3 gap-y-3 text-gray-400 mt-3`}>
            <div>
              ...
              <div className='relative mt-2'>
                <input type="text" className='border border-button/30  pl-3 pr-15 py-2 rounded-sm w-full outline-0 text-white' defaultValue={`${rezervare[0].pretNoapte}`} name="" id="" />
            ...
            <div>
              <p>Perioada cazare</p>
              <div className='relative mt-2'>
                <input type="text" className='border border-button/30  pl-3 pr-15 py-2 rounded-sm w-full outline-0 text-white' defaultValue={`${rezervare[0].nrPerioada}`} name="" id="" />
            ...
            <div>
              <p>Reducere</p>
              <div className='relative mt-2'>
                <input type="text" className='border border-button/30  pl-3 pr-15 py-2 rounded-sm w-full outline-0 text-white' defaultValue={`${reducere}`} name="" id="" />
                <p className='absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none'>RON</p>
              </div>
            </div>
