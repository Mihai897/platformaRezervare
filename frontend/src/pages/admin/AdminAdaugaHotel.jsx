    ...
    <div>
      ...
      <div className='border border-button/30  py-3 mt-3 rounded-lg'>
        ...
        <div className={`grid grid-cols-2 px-3 gap-3 pb-3 border-b-button/30 text-gray-400 border-b ${visibleBara?"max-modf1:grid-cols-1":" max-modf2:grid-cols-1"}`}>
          ...
          <div>
            <p className='mt-2'>Id hotel <span className='text-red-600'>*</span></p>
            <input className='border border-button/30 w-full px-3 outline-0 py-2 mt-2 text-white' type="text" placeholder='Ex: HTL-008' name="" id="" />
          </div>
        ...
        <div className={`mt-6 px-3 grid grid-cols-3 ${visibleBara?"max-modf4:grid-cols-2 max-modf1:grid-cols-1":"max-modf:grid-cols-2 max-modf2:grid-cols-1"} gap-3`}>
          <div className='px-3 py-3 border border-button/60 rounded-sm'>
            ...
            <div className='grid grid-cols-2 gap-3 max-modf8:grid-cols-1'>
              <div>
                <p className='text-gray-400 mt-2'>Check-in <span className='text-red-600'>*</span></p>
                <div className='relative mt-2'>
                  <input type="date" className='border border-button/30 w-full px-3 pr-1.5 [&::-webkit-calendar-picker-indicator]:invert py-1.5 outline-0 rounded-sm' name="" id="" />
                  
                </div>
              </div>
              <div>
                <p className='text-gray-400 mt-2'>Check-out <span className='text-red-600'>*</span></p>
                <div className='relative mt-2'>
                  <input type="date" className='border border-button/30 w-full px-3 pr-1.5 [&::-webkit-calendar-picker-indicator]:invert py-1.5 outline-0 rounded-sm ' name="" id="" />
          ...
          <div className='px-3 py-3 border border-button/60 rounded-sm'>
            ...
            <div className='mt-2 flex space-x-3 items-center text-gray-400'>
              <button onClick={()=>setAnulareButon(!anulareButon)} className={`w-10 h-5 cursor-pointer  rounded-full relative transition-all duration-300 ease-in-out ${anulareButon===false?"bg-gray-400":"bg-button"}`}>
