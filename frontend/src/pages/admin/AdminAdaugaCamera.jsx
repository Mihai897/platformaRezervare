        ...
        <div>
              ...
              <button onClick={()=>setVisibleSelectHotel(!visibleSelectHotel)} className={`${visibleSelectHotel?"rounded-t-sm bg-button/30":"rounded-sm bg-background"} border border-button/30 w-full px-3 py-1.5  flex items-center space-x-3 justify-between cursor-pointer hover:bg-button/30 transition-all duration-300 ease-in-out`}>
                <div className='flex items-center space-x-3'>
                  <div className='shrink-0'>
                    <img className='w-15 shrink-0 h-10 rounded-sm' src={hotels[0].img} alt="" />
                  </div>
              ...
              <ul className={`absolute left-0 bg-background w-full z-100 overflow-y-auto overflow-hidden transition-all duration-500 ease-in-out  scrollbar-thin ${visibleSelectHotel?"max-h-40 opacity-100" :"max-h-0 opacity-0"}`}>
                {
                  hotels.map((hotel,iHotel)=>(
                    <li key={iHotel} className='border border-button/30 w-full px-3 py-1.5  flex items-center space-x-3  cursor-pointer hover:bg-button/30 transition-all duration-300 ease-in-out'>
                      <div className='flex items-center space-x-3'>
                        <div className='shrink-0'>
                          <img className='w-15 shrink-0 h-10 rounded-sm' src={hotel.img} alt="" />
                        </div>
                        <div className='text-start'>
                          <p>{hotel.nume}</p>
                          <p>{hotel.locatie}</p>
          ...
          <div className='mt-3'>
            ...
            <div className='mt-3'>
              ...
              <div>
                  <p className='text-gray-400'>Pret camera <span className='text-red-600'>*</span></p>
                  ...
                  <label className='relative' htmlFor=""> 
                    ...
                    peer-focus:px-3
                    peer-focus:text-button
                    '>Introduceti pretul camerei</span>
                  </label>
            ...
            <div className='mt-3 '>
              ...
              <div className='mt-1 flex items-center overflow-x-auto overflow-hidden scrollbar-thin space-x-3 pb-3'>
                <div className='flex items-center space-x-1.5 shrink-0 bg-button/30 rounded-sm px-3'>
                  <p>Piscina privata</p>
