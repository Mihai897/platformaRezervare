...
const Ghid = () => {
  ...
  return (
    ...
    <div className=''>
      ...
      <div className='flex text-white max-modf1:flex-col max-modf1:space-y-3 mt-4 max-w-screen-2xl mx-auto px-15 bg-button1/50 max-modf:px-10 max-modf1:px-8 items-start modf1:space-x-5 py-4 border-y border-y-button/15'>
         <GhidSidebar/>
        <Outlet/>
      </div>
    </div>
