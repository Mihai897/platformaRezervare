...
const CumFunctioneaza = () => {
  ...
  return (
    <div className=' py-4  '>
      ...
      <div className='flex justify-center max-w-screen-2xl mx-auto px-15 max-modf:px-10 max-modf1:px-8'>
      ...
      <div className='pt-4 max-w-screen-2xl mx-auto px-15 max-modf:px-10 max-modf1:px-8'>
      ...
      <div className='mt-4 max-w-screen-2xl mx-auto px-15 max-modf:px-10 max-modf1:px-8'>
      ...
      <div className=' py-7 mt-8 bg-button1 border-y border-y-button/15'>
        <div className='flex flex-col items-center max-w-screen-2xl mx-auto px-15 max-modf:px-10 max-modf1:px-8 '>
