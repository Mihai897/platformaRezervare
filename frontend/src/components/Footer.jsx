...
const Footer = () => {
  ...
  return (
    <div className=' max-w-screen-2xl mx-auto px-15 max-modf:px-10 max-modf1:px-8 py-10 grid grid-cols-4 gap-6 max-modf:gap-3 max-modf:text-[14px]  max-modf1:grid-cols-1  max-modf1:gap-2 text-[14.5px] '>
      <div className=' '>
